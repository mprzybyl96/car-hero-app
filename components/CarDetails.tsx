...
const CarDetails = ({ car, isOpen, closeModal }: ICarDetails) => {
  const CarProperties = () => {
              ...
              >
                <Dialog.Panel className="relative w-full p-6 max-w-lg max-h-[90vh] overflow-y-auto transform rounded-2xl bg-white text-left shadow-xl transition-all flex flex-col gap-5">
                  ...
                  <div className="flex-1 flex flex-col gap-3">
                    <div className="relative w-full h-40 bg-pattern bg-cover bg-centern rounded-lg">
                      <Image
                        src="/hero.png"
                        alt="car-model"
                        fill
